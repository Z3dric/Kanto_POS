...
class Sale {
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      // store items as JSON text for SQLite (used by json_each/json_extract)
    ...
    return Sale(
      ...
      items: (() {
        ...
        if (rawItems is String) {
          decoded = jsonDecode(rawItems) as List<dynamic>;
        ...
        return List<TransactionItem>.from(
          decoded.map((item) => TransactionItem.fromMap(Map<String, dynamic>.from(item))),
        );
      })(),
      ...
      refundedAt:
          map['refundedAt'] != null ? DateTime.parse(map['refundedAt']) : null,
